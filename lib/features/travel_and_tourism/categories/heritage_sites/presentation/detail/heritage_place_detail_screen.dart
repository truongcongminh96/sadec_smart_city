...
class HeritagePlaceDetailScreen extends StatefulWidget {
  ...
  @override
  State<HeritagePlaceDetailScreen> createState() => _HeritagePlaceDetailScreenState();
}
...
class _HeritagePlaceDetailScreenState extends State<HeritagePlaceDetailScreen> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => HeritagePlaceDetailCubit(getIt())..loadDetailHeritagePlace(widget.tableId, widget.detailId),
      child: BlocBuilder<HeritagePlaceDetailCubit, HeritagePlaceDetailState>(
        builder: (context, state) {
          if (state is HeritagePlaceDetailLoading) {
            ...
            return Scaffold(
              backgroundColor: const Color(0xFF223333),
              body: SafeArea(
                child: LayoutBuilder(
