...
class TourismAttractionCard extends StatefulWidget {
  final TourismPlaceModel place;

  const TourismAttractionCard({super.key, required this.place});

  @override
  State<TourismAttractionCard> createState() => _TourismAttractionCardState();
}

class _TourismAttractionCardState extends State<TourismAttractionCard>
